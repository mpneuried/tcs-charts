...
(function() {
  ...
  module.exports = Speedo = (function() {
    ...
    Speedo.prototype._rad = 2 * Math.PI / 360;

    Speedo.prototype.getter = function(prop, fnGet, obj) {
      if (obj == null) {
        obj = this;
      }
    ...
    Speedo.prototype.setter = function(prop, fnGet, obj) {
      if (obj == null) {
        obj = this;
      }
      Object.defineProperty(obj, prop, {
    ...
    Speedo.prototype.define = function(prop, oDef, obj) {
      Object.defineProperty(obj, prop, oDef);
    };

    function Speedo(target, startValue, options) {
      var oDef,
        _this = this;
      this.target = target;
      if (startValue == null) {
    ...
    Speedo.prototype._initOptions = function(options, def) {
      var _k;
      if (def == null) {
        def = false;
      }
      if (def) {
        this.opt = _.extend({}, this.defaults, options);
      }
    ...
    Speedo.prototype._initOption = function(key) {
      var odef,
        _this = this;
      odef = {
        get: function() {
    ...
    Speedo.prototype._angleToRad = function(angl) {
      return this._rad * angl;
    };

    Speedo.prototype._radToAngle = function(rad) {
      return rad / this._rad;
    };

    Speedo.prototype._arc = function(end) {
      var arc;
    ...
    Speedo.prototype.create = function() {
      var _tgrt;
    ...
    Speedo.prototype._calcNeedle = function() {
      var _h, _w;
      _w = this.opt.width;
      _h = this.opt.height;
    ...
    Speedo.prototype._getAngleByFactor = function(factor) {
      return d3.interpolate(this.opt.startAngle, this.opt.endAngle)(factor);
    };

    Speedo.prototype._getColorByFactor = function(factor) {
      return d3.interpolateRgb(this.opt.startColor, this.opt.endColor)(factor);
    };

    Speedo.prototype._set = function(_value, duration) {
      this._value = _value;
      if (duration == null) {
    ...
    Speedo.prototype.tween = function(transition, factor) {
      var _angle, _color,
        _this = this;
    ...
    Speedo.prototype.tweenNeedle = function(transition, factor) {
      var newAngle,
        _this = this;
...
require.alias("mbostock-d3/index-browserify.js", "tcs-charts/deps/d3/index-browserify.js");
require.alias("mbostock-d3/d3.js", "tcs-charts/deps/d3/d3.js");
require.alias("mbostock-d3/index-browserify.js", "tcs-charts/deps/d3/index.js");
